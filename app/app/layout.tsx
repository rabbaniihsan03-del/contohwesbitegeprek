...
export const metadata: Metadata = {
  ...
  description: 'Nikmati sensasi ayam geprek pedas dengan sambal khas homemade. Geprek rabbdev - Ayam Geprek yang Bikin Nagih!',
  keywords: ['ayam geprek', 'geprek pedas', 'makanan pedas', 'street food', 'UMKM', 'kuliner Indonesia'],
  authors: [{ name: 'Geprek rabbdev' }],
  creator: 'Geprek rabbdev',
 openGraph: {
  type: 'website',
  locale: 'id_ID',
  url: 'https://contohwebsitegeprek.vercel.app',
